...
function LoginForm() {
  ...
  const errorMessages = [
    ...
    {
      condition: usernameTest,
      message:
        "유효한 ID를 사용해주세요: 5~20자의 영문자, 숫자와 특수기호(_, -)",
    },
    {
      condition: pwTest,
      message:
        "유효한 비밀번호를 사용해주세요: 8~16자의 영문 대/소문자, 숫자, 특수문자",
    },
  ];
        ...
        <motion.form layout className="login_form" onSubmit={handleSubmit}>
          {isAbout ? (
            <>
              ...
              <p>
                <b>TIL Board</b>는 개발자들이 하루 동안 배운 것, 겪은 시행착오,
                <br />
                그리고 깨달음을 쉽고 빠르게 기록하고 공유할 수 있는
                <br />
                <b>개발자 중심의 데일리 회고 플랫폼</b>입니다.
              </p>
              <h2>이런 분들께 추천합니다</h2>
              ...
              <h2>기록은 곧 성장입니다</h2>
              <span>
                개발자는 늘 배우고, 실수하고, 다시 일어섭니다.
                <br />
                <strong>TIL Board</strong>는 그 과정을 함께합니다.
                <br />
                오늘의 당신이 내일의 당신을 성장시킵니다.
              </span>
            </>
          ) : (
